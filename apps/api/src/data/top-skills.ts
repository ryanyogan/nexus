...
export const TOP_SKILLS: SkillEntry[] = [
  ...
  },
  {
    ...
    description: "Measure and reduce code complexity",
    category: "analysis",
  ...
  },
  {
    ...
    description: "Check UI for accessibility compliance (WCAG)",
    category: "analysis",
  ...
  },
  {
    id: "seo-analysis",
    name: "SEO Analysis",
    description: "Analyze and improve SEO for web pages",
    category: "analysis",
  ...
  },
  {
    ...
    category: "analysis",
    tags: ["bundle", "webpack", "performance"],
    priority: 4,
  },
  {
    id: "type-coverage",
    name: "Type Coverage Analysis",
    description: "Identify untyped code and improve TypeScript coverage",
    category: "analysis",
    tags: ["typescript", "types", "coverage"],
    priority: 4,
  },
  {
    id: "dead-code",
  ...
  },
  {
    ...
    description: "Identify potential memory leaks in code",
    category: "analysis",
  ...
  },
  {
    ...
    description: "Find potential race conditions in async code",
    category: "analysis",
  ...
  },
  {
    ...
    category: "analysis",
    tags: ["quality", "patterns", "refactoring"],
    priority: 4,
  },
  ...
  // ============================================================================
  {
    ...
    description: "Generate React functional components with hooks",
    category: "generation",
  ...
  },
  {
    id: "vue-composable",
    name: "Vue Composable",
    description: "Create Vue composables for reusable logic",
    category: "generation",
  ...
  },
  {
    ...
    description: "Generate Svelte components",
    category: "generation",
    tags: ["svelte", "components", "frontend"],
    priority: 4,
  },
  {
    id: "angular-component",
    name: "Angular Component",
    description: "Generate Angular components with services",
    category: "generation",
  ...
  },
  {
    id: "web-component",
    name: "Web Component",
    description: "Create vanilla Web Components",
    category: "generation",
    tags: ["web-components", "custom-elements", "frontend"],
    priority: 3,
  },
  {
    id: "shadcn-component",
    name: "shadcn/ui Component",
    description: "Generate shadcn/ui styled components",
    category: "generation",
  ...
  },
  {
    ...
    description: "Create components with Tailwind CSS",
    category: "generation",
  ...
  },
  {
    id: "table-component",
    name: "Data Table",
    description: "Create sortable, filterable data tables",
    category: "generation",
    tags: ["tables", "data", "ui"],
    priority: 4,
  },
  {
    id: "modal-component",
    name: "Modal/Dialog",
    description: "Generate accessible modal dialogs",
    category: "generation",
  ...
  },
  {
    ...
    name: "Dropdown Menu",
    description: "Create accessible dropdown menus",
    category: "generation",
    tags: ["dropdown", "menu", "ui"],
    priority: 4,
  },
  {
    id: "toast-component",
    name: "Toast Notifications",
    description: "Generate toast notification system",
    category: "generation",
  ...
  },
  {
    ...
    name: "Image Carousel",
    description: "Create responsive image carousels",
    category: "generation",
    tags: ["carousel", "images", "ui"],
    priority: 3,
  },
  ...
  },
  {
    ...
    description: "Create GraphQL resolvers and types",
    category: "generation",
  ...
  },
  {
    id: "trpc-router",
    name: "tRPC Router",
    description: "Generate type-safe tRPC routers",
    category: "generation",
  ...
  },
  {
    ...
    description: "Create Express.js middleware functions",
    category: "generation",
  ...
  {
    id: "hono-handler",
    name: "Hono Route Handler",
    description: "Generate Hono API handlers",
    category: "generation",
    tags: ["hono", "cloudflare", "edge"],
    priority: 4,
  },
  {
    id: "fastify-plugin",
    name: "Fastify Plugin",
    description: "Create Fastify plugins and routes",
    category: "generation",
    tags: ["fastify", "plugins", "backend"],
    priority: 4,
  },
  {
    id: "nextjs-api-route",
  ...
  },
  {
    ...
    category: "generation",
    tags: ["nextjs", "server-actions", "fullstack"],
    priority: 5,
  },
  {
    id: "cloudflare-worker",
    name: "Cloudflare Worker",
    description: "Generate Cloudflare Worker scripts",
    category: "generation",
  ...
  },
  {
    ...
    description: "Create AWS Lambda handlers",
    category: "generation",
  ...
  },
  {
    ...
    description: "Generate webhook endpoint handlers",
    category: "generation",
  ...
  {
    id: "cron-job",
    name: "Cron Job/Scheduled Task",
    description: "Create scheduled task handlers",
    category: "generation",
  ...
  },
  {
    id: "queue-worker",
    name: "Queue Worker",
    description: "Generate message queue consumers",
    category: "generation",
  ...
  },
  {
    ...
    description: "Create WebSocket connection handlers",
    category: "generation",
  ...
  },
  {
    ...
    description: "Generate SSE streaming endpoints",
    category: "generation",
    tags: ["sse", "streaming", "realtime"],
    priority: 3,
  },
  ...
  // ============================================================================
  {
    id: "prisma-schema",
    name: "Prisma Schema",
    description: "Generate Prisma database schemas",
    category: "generation",
  ...
  },
  {
    id: "drizzle-schema",
    name: "Drizzle Schema",
    description: "Create Drizzle ORM schemas",
    category: "generation",
  ...
  },
  {
    ...
    category: "generation",
    tags: ["sql", "migrations", "database"],
    priority: 5,
  },
  {
    id: "mongoose-model",
    name: "Mongoose Model",
    description: "Create MongoDB Mongoose models",
    category: "generation",
  ...
  },
  {
    id: "typeorm-entity",
    name: "TypeORM Entity",
    description: "Generate TypeORM entity classes",
    category: "generation",
  ...
  },
  {
    id: "seed-data",
    name: "Seed Data",
    description: "Generate database seed scripts",
    category: "generation",
    tags: ["seeding", "testing", "database"],
    priority: 3,
  },
  {
    id: "database-trigger",
    name: "Database Trigger",
    description: "Create database triggers and functions",
    category: "generation",
  ...
  },
  {
    ...
    description: "Implement Redis caching patterns",
    category: "generation",
  ...
  // ============================================================================
  {
    ...
    description: "Implement complete auth flows",
    category: "generation",
  ...
  },
  {
    ...
    description: "Add OAuth provider authentication",
    category: "generation",
    tags: ["oauth", "social-login", "auth"],
    priority: 5,
  },
  {
    id: "jwt-auth",
  ...
  },
  {
    ...
    description: "Create session-based auth system",
    category: "generation",
  ...
  },
  {
    ...
    description: "Generate password reset functionality",
    category: "generation",
  ...
  },
  {
    ...
    description: "Add 2FA/MFA authentication",
    category: "generation",
  ...
  },
  {
    ...
    description: "Implement RBAC authorization",
    category: "generation",
  ...
  },
  {
    ...
    description: "Create API key auth system",
    category: "generation",
    tags: ["api-keys", "auth", "backend"],
    priority: 4,
  },
  {
    id: "magic-link-auth",
    name: "Magic Link Auth",
    description: "Implement passwordless magic links",
    category: "generation",
    tags: ["magic-link", "passwordless", "auth"],
    priority: 3,
  },
  {
    id: "passkey-auth",
    name: "Passkey/WebAuthn",
    description: "Add WebAuthn passkey support",
    category: "generation",
  ...
  },
  {
    ...
    category: "documentation",
    tags: ["jsdoc", "comments", "typescript"],
    priority: 4,
  },
  {
    id: "typedoc-generation",
    name: "TypeDoc Generation",
    description: "Generate TypeDoc documentation",
    category: "documentation",
    tags: ["typedoc", "typescript", "docs"],
    priority: 4,
  },
  {
    id: "changelog",
    name: "Changelog Generation",
    description: "Create changelogs from commits",
    category: "documentation",
  ...
  },
  {
    id: "code-comments",
    name: "Code Comments",
    description: "Add explanatory code comments",
    category: "documentation",
    tags: ["comments", "explanation", "clarity"],
    priority: 4,
  },
  {
    ...
    category: "documentation",
    tags: ["architecture", "diagrams", "design"],
    priority: 4,
  },
  {
    id: "contributing-guide",
    name: "Contributing Guide",
    description: "Create CONTRIBUTING.md files",
    category: "documentation",
    tags: ["contributing", "opensource", "community"],
    priority: 3,
  },
  {
    id: "deployment-docs",
    name: "Deployment Documentation",
    description: "Document deployment processes",
    category: "documentation",
  ...
  },
  {
    ...
    description: "Generate Storybook component stories",
    category: "documentation",
  ...
  },
  {
    ...
    description: "Add comprehensive inline docs",
    category: "documentation",
    tags: ["inline", "comments", "maintenance"],
    priority: 3,
  },
  {
    id: "tutorial-creation",
    name: "Tutorial Creation",
    description: "Write step-by-step tutorials",
    category: "documentation",
    tags: ["tutorials", "learning", "guides"],
    priority: 3,
  },
  {
    id: "runbook-creation",
    ...
    category: "documentation",
    tags: ["runbooks", "operations", "devops"],
    priority: 3,
  },
  {
    id: "adr-documentation",
  ...
  },
  {
    id: "error-catalog",
    name: "Error Catalog",
    description: "Document error codes and messages",
    category: "documentation",
    tags: ["errors", "debugging", "support"],
    priority: 3,
  },
  ...
  },
  {
    ...
    description: "Create React/Vue component tests",
    category: "testing",
    tags: ["components", "testing-library", "ui"],
    priority: 5,
  },
  {
    id: "api-test",
    name: "API Tests",
    description: "Generate API endpoint tests",
    category: "testing",
    tags: ["api", "supertest", "backend"],
    priority: 5,
  },
  {
    id: "snapshot-test",
    name: "Snapshot Tests",
    description: "Create snapshot tests for UI",
    category: "testing",
  ...
  },
  {
    ...
    description: "Generate mocks and fixtures",
    category: "testing",
    tags: ["mocks", "fixtures", "testing"],
    priority: 4,
  },
  {
    id: "test-coverage",
    name: "Test Coverage",
    description: "Improve test coverage systematically",
    category: "testing",
    tags: ["coverage", "quality", "testing"],
    priority: 4,
  },
  {
    id: "mutation-testing",
    ...
    category: "testing",
    tags: ["mutation", "stryker", "quality"],
    priority: 3,
  },
  {
    id: "load-testing",
    name: "Load Testing",
    description: "Create load test scenarios",
    category: "testing",
    tags: ["load", "performance", "k6"],
    priority: 3,
  },
  {
    ...
    category: "testing",
    tags: ["visual", "screenshots", "ui"],
    priority: 3,
  },
  {
    id: "contract-testing",
    name: "Contract Testing",
    description: "Implement API contract tests",
    category: "testing",
  ...
  },
  {
    ...
    category: "testing",
    tags: ["property", "fast-check", "testing"],
    priority: 3,
  },
  {
    id: "accessibility-test",
    name: "Accessibility Tests",
    description: "Create a11y automated tests",
    category: "testing",
  ...
  // ============================================================================
  {
    ...
    tags: ["clean-code", "readability", "maintenance"],
    priority: 5,
  },
  {
    id: "extract-function",
    name: "Extract Function",
    description: "Extract reusable functions from code",
    category: "refactoring",
    tags: ["functions", "dry", "modular"],
    priority: 5,
  },
  {
    ...
    category: "refactoring",
    tags: ["components", "reuse", "ui"],
    priority: 5,
  },
  {
    id: "design-patterns",
    name: "Apply Design Patterns",
    description: "Implement appropriate design patterns",
    category: "refactoring",
  ...
  },
  {
    ...
    description: "Refactor to follow SOLID principles",
    category: "refactoring",
  ...
  },
  {
    ...
    description: "Identify and remove code duplication",
    category: "refactoring",
    tags: ["dry", "duplication", "cleanup"],
    priority: 5,
  },
  {
    ...
    category: "refactoring",
    tags: ["conditionals", "logic", "readability"],
    priority: 4,
  },
  {
    id: "modernize-code",
    name: "Modernize Code",
    description: "Update to modern syntax and APIs",
    category: "refactoring",
    tags: ["modern", "es6", "upgrade"],
    priority: 4,
  },
  {
  ...
  {
    id: "async-refactor",
    name: "Async/Await Refactor",
    description: "Convert callbacks to async/await",
    category: "refactoring",
    tags: ["async", "promises", "modern"],
    priority: 4,
  },
  {
    id: "composition-refactor",
    name: "Composition over Inheritance",
    description: "Refactor from inheritance to composition",
    category: "refactoring",
  ...
  },
  {
    ...
    description: "Implement DI patterns",
    category: "refactoring",
    tags: ["di", "testing", "decoupling"],
    priority: 4,
  },
  {
    id: "error-handling",
  ...
  },
  {
    id: "code-splitting",
    name: "Code Splitting",
    description: "Implement code splitting for performance",
    category: "refactoring",
  ...
  },
  {
    ...
    description: "Write Terraform IaC scripts",
    category: "devops",
  ...
  },
  {
    ...
    description: "Create Nginx server configs",
    category: "devops",
    tags: ["nginx", "server", "proxy"],
    priority: 4,
  },
  {
    id: "env-management",
  ...
  },
  {
    ...
    description: "Implement deployment rollbacks",
    category: "devops",
    tags: ["rollback", "deployment", "safety"],
    priority: 3,
  },
  {
    id: "secrets-management",
    name: "Secrets Management",
    description: "Set up secure secrets handling",
    category: "devops",
  ...
  },
  {
    ...
    description: "Configure CDN for assets",
    category: "devops",
  ...
  // ============================================================================
  {
    id: "react-context",
    name: "React Context",
    description: "Create React Context providers",
    category: "framework",
  ...
  },
  {
    ...
    description: "Configure TanStack Query",
    category: "framework",
  ...
  },
  {
    ...
    description: "Set up React Hook Form",
    category: "framework",
  ...
  },
  {
    id: "react-suspense",
    name: "React Suspense",
    description: "Implement Suspense patterns",
    category: "framework",
  ...
  },
  {
    ...
    name: "Error Boundary",
    description: "Create React error boundaries",
    category: "framework",
  ...
  },
  {
    id: "react-portal",
    name: "React Portal",
    description: "Implement React portals",
    category: "framework",
  ...
  },
  {
    ...
    description: "Optimize with React.memo",
    category: "framework",
  ...
  },
  {
    ...
    description: "Implement render props",
    category: "framework",
  ...
  },
  {
    ...
    description: "Add animations with Framer Motion",
    category: "framework",
  ...
  },
  {
    ...
    description: "Set up Testing Library",
    category: "framework",
  ...
  },
  {
    ...
    description: "Configure Storybook for React",
    category: "framework",
    tags: ["react", "storybook", "docs"],
    priority: 4,
  },
  {
    id: "react-i18n",
    name: "React Internationalization",
    description: "Add i18n with react-i18next",
    category: "framework",
  ...
  // ============================================================================
  {
    ...
    description: "Set up App Router patterns",
    category: "framework",
    tags: ["nextjs", "routing", "rsc"],
    priority: 5,
  },
  {
    id: "nextjs-middleware",
    name: "Next.js Middleware",
    description: "Create Edge middleware",
    category: "framework",
  ...
  },
  {
    ...
    description: "Implement RSC patterns",
    category: "framework",
    tags: ["nextjs", "rsc", "server"],
    priority: 5,
  },
  {
    id: "nextjs-data-fetching",
    name: "Next.js Data Fetching",
    description: "Implement data fetching patterns",
    category: "framework",
    tags: ["nextjs", "fetching", "caching"],
    priority: 5,
  },
  {
    id: "nextjs-auth",
  ...
  },
  {
    id: "nextjs-seo",
    name: "Next.js SEO",
    description: "Configure SEO with metadata API",
    category: "framework",
  ...
  },
  {
    ...
    description: "Implement streaming SSR",
    category: "framework",
  ...
  },
  {
    ...
    description: "Set up parallel routes",
    category: "framework",
  ...
  },
  {
    ...
    description: "Create intercepting routes",
    category: "framework",
    tags: ["nextjs", "routing", "modals"],
    priority: 3,
  },
  {
    id: "nextjs-error-handling",
    name: "Next.js Error Handling",
    description: "Implement error.tsx patterns",
    category: "framework",
    tags: ["nextjs", "errors", "boundaries"],
    priority: 4,
  },
  {
    id: "nextjs-loading",
    name: "Next.js Loading States",
    description: "Add loading.tsx patterns",
    category: "framework",
    tags: ["nextjs", "loading", "suspense"],
    priority: 4,
  },
  {
    id: "nextjs-og-images",
    ...
    category: "framework",
    tags: ["nextjs", "og", "social"],
    priority: 3,
  },
  {
    id: "nextjs-sitemap",
    name: "Next.js Sitemap",
    description: "Generate sitemap.xml",
    category: "framework",
    tags: ["nextjs", "seo", "sitemap"],
    priority: 3,
  },
  {
    id: "nextjs-ratelimit",
    name: "Next.js Rate Limiting",
    description: "Add rate limiting middleware",
    category: "framework",
    tags: ["nextjs", "security", "ratelimit"],
    priority: 4,
  },
  ...
  // ============================================================================
  {
    id: "vue-pinia",
    name: "Pinia Store",
    description: "Create Pinia state stores",
    category: "framework",
  ...
  },
  {
    ...
    description: "Use VueUse utility composables",
    category: "framework",
    tags: ["vue", "vueuse", "composables"],
    priority: 4,
  },
  {
    id: "vue-transitions",
    name: "Vue Transitions",
    description: "Add Vue transition effects",
    category: "framework",
    tags: ["vue", "transitions", "animation"],
    priority: 3,
  },
  {
    id: "vue-teleport",
    name: "Vue Teleport",
    description: "Use Vue Teleport component",
    category: "framework",
    tags: ["vue", "teleport", "portal"],
    priority: 3,
  },
  {
    id: "nuxt-module",
    name: "Nuxt Module",
    description: "Create Nuxt.js modules",
    category: "framework",
    tags: ["nuxt", "modules", "plugins"],
    priority: 4,
  },
  {
    id: "nuxt-middleware",
    name: "Nuxt Middleware",
    description: "Write Nuxt route middleware",
    category: "framework",
  ...
  },
  {
    ...
    description: "Create auto-imported composables",
    category: "framework",
    tags: ["nuxt", "composables", "auto-import"],
    priority: 4,
  },
  {
    id: "nuxt-api",
    name: "Nuxt API Routes",
    description: "Create Nitro API endpoints",
    category: "framework",
    tags: ["nuxt", "nitro", "api"],
    priority: 4,
  },
  {
    ...
    description: "Add auth to Nuxt apps",
    category: "framework",
    tags: ["nuxt", "auth", "sidebase"],
    priority: 4,
  },
  ...
  // ============================================================================
  {
    id: "svelte-store",
    name: "Svelte Store",
    description: "Create Svelte writable stores",
    category: "framework",
  ...
  },
  {
    id: "svelte-action",
    name: "Svelte Action",
    description: "Create Svelte actions",
    category: "framework",
    tags: ["svelte", "actions", "dom"],
    priority: 4,
  },
  {
    id: "sveltekit-load",
    name: "SvelteKit Load Function",
    description: "Implement load functions",
    category: "framework",
    tags: ["sveltekit", "loading", "data"],
    priority: 4,
  },
  {
    id: "sveltekit-hooks",
    name: "SvelteKit Hooks",
    description: "Create server hooks",
    category: "framework",
    tags: ["sveltekit", "hooks", "server"],
    priority: 4,
  },
  {
    id: "sveltekit-form",
    name: "SvelteKit Form Actions",
    description: "Implement form actions",
    category: "framework",
  ...
  // ============================================================================
  {
    ...
    description: "Define complex TypeScript types",
    category: "language",
  ...
  },
  {
    ...
    description: "Create generic types and functions",
    category: "language",
    tags: ["typescript", "generics", "reuse"],
    priority: 5,
  },
  {
    id: "ts-utility-types",
    name: "Utility Types",
    description: "Use and create utility types",
    category: "language",
  ...
  },
  {
    id: "ts-type-guards",
    name: "Type Guards",
    description: "Implement type guard functions",
    category: "language",
    tags: ["typescript", "guards", "narrowing"],
    priority: 4,
  },
  {
    id: "ts-mapped-types",
    name: "Mapped Types",
    description: "Create mapped types",
    category: "language",
    tags: ["typescript", "mapped", "advanced"],
    priority: 4,
  },
  {
    id: "ts-conditional",
    name: "Conditional Types",
    description: "Write conditional types",
    category: "language",
    tags: ["typescript", "conditional", "advanced"],
    priority: 4,
  },
  {
    id: "ts-infer",
    name: "Type Inference",
    description: "Use infer keyword effectively",
    category: "language",
  ...
  },
  {
    ...
    description: "Create and use decorators",
    category: "language",
  ...
  },
  {
    ...
    category: "language",
    tags: ["typescript", "config", "setup"],
    priority: 4,
  },
  {
    id: "ts-strict-mode",
    name: "Strict Mode Migration",
    description: "Enable strict TypeScript",
    category: "language",
  ...
  },
  {
    id: "ts-branded-types",
    name: "Branded Types",
    description: "Create branded/nominal types",
    category: "language",
    tags: ["typescript", "branded", "safety"],
    priority: 3,
  },
  {
    id: "ts-template-literal",
    name: "Template Literal Types",
    description: "Use template literal types",
    category: "language",
    tags: ["typescript", "template", "strings"],
    priority: 3,
  },
  {
    id: "ts-satisfies",
    name: "Satisfies Operator",
    description: "Use satisfies for type checking",
    category: "language",
    tags: ["typescript", "satisfies", "inference"],
    priority: 3,
  },
  {
    id: "ts-const-assertion",
    name: "Const Assertions",
    description: "Use as const effectively",
    category: "language",
    tags: ["typescript", "const", "readonly"],
    priority: 4,
  },
  {
    id: "ts-discriminated-union",
    name: "Discriminated Unions",
    description: "Create discriminated unions",
    category: "language",
  ...
  },
  {
    ...
    description: "Create Python dataclasses",
    category: "language",
    tags: ["python", "dataclass", "models"],
    priority: 4,
  },
  {
    id: "python-pydantic",
    name: "Pydantic Models",
    description: "Define Pydantic schemas",
    category: "language",
  ...
  },
  {
    ...
    description: "Write async Python code",
    category: "language",
  ...
  },
  {
    ...
    description: "Create Python decorators",
    category: "language",
  ...
  },
  {
    ...
    description: "Implement context managers",
    category: "language",
    tags: ["python", "context", "with"],
    priority: 3,
  },
  {
    id: "python-generator",
  ...
  },
  {
    ...
    description: "Write Pythonic comprehensions",
    category: "language",
    tags: ["python", "comprehension", "idioms"],
    priority: 4,
  },
  {
    id: "fastapi-endpoint",
  ...
  // ============================================================================
  {
    id: "go-struct",
    name: "Go Struct",
    description: "Define Go structs with tags",
    category: "language",
  ...
  },
  {
    id: "go-interface",
    name: "Go Interface",
    description: "Create Go interfaces",
    category: "language",
    tags: ["go", "interface", "polymorphism"],
    priority: 4,
  },
  {
    id: "go-goroutine",
  ...
  },
  {
    id: "go-channel",
    name: "Go Channels",
    description: "Implement channel patterns",
    category: "language",
    tags: ["go", "channels", "communication"],
    priority: 4,
  },
  {
    id: "go-error-handling",
    name: "Go Error Handling",
    description: "Implement Go error patterns",
    category: "language",
  ...
  },
  {
    id: "go-middleware",
    name: "Go Middleware",
    description: "Write HTTP middleware",
    category: "language",
    tags: ["go", "middleware", "http"],
    priority: 4,
  },
  {
    id: "go-context",
    name: "Go Context",
    description: "Use context properly",
    category: "language",
  ...
  },
  {
    id: "go-generics",
    name: "Go Generics",
    description: "Write generic Go code",
    category: "language",
  ...
  // ============================================================================
  {
    id: "rust-struct",
    name: "Rust Struct",
    description: "Define Rust structs with derive",
    category: "language",
    tags: ["rust", "struct", "types"],
    priority: 4,
  },
  {
    id: "rust-enum",
    name: "Rust Enum",
    description: "Create Rust enums with variants",
    category: "language",
    tags: ["rust", "enum", "pattern-matching"],
    priority: 4,
  },
  {
    id: "rust-trait",
    name: "Rust Trait",
    description: "Implement Rust traits",
    category: "language",
    tags: ["rust", "trait", "polymorphism"],
    priority: 4,
  },
  {
    id: "rust-result",
    name: "Rust Result Handling",
    description: "Use Result for error handling",
    category: "language",
    tags: ["rust", "result", "errors"],
    priority: 4,
  },
  {
    id: "rust-option",
    name: "Rust Option Handling",
    description: "Work with Option types",
    category: "language",
  ...
  },
  {
    id: "rust-lifetime",
    name: "Rust Lifetimes",
    description: "Annotate lifetime parameters",
    category: "language",
  ...
  },
  {
    id: "rust-async",
    name: "Rust Async",
    description: "Write async Rust code",
    category: "language",
  ...
  },
  {
    id: "rust-macro",
    name: "Rust Macros",
    description: "Create Rust macros",
    category: "language",
  ...
  },
  {
    id: "rust-testing",
    name: "Rust Testing",
    description: "Write Rust unit tests",
    category: "language",
  ...
  // ============================================================================
  {
    id: "cart-system",
    name: "Shopping Cart",
    description: "Implement shopping cart logic",
    category: "domain",
  ...
  },
  {
    id: "checkout-flow",
    name: "Checkout Flow",
    description: "Build checkout process",
    category: "domain",
  ...
  },
  {
    ...
    description: "Create product catalog system",
    category: "domain",
  ...
  },
  {
    ...
    category: "domain",
    tags: ["ecommerce", "inventory", "stock"],
    priority: 4,
  },
  {
    id: "order-management",
  ...
  },
  {
    ...
    description: "Implement recurring billing",
    category: "domain",
  ...
  },
  {
    ...
    description: "Create discount logic",
    category: "domain",
    tags: ["ecommerce", "discounts", "coupons"],
    priority: 3,
  },
  {
    ...
    category: "domain",
    tags: ["ecommerce", "shipping", "logistics"],
    priority: 3,
  },
  {
    id: "tax-calculation",
  ...
  },
  {
    ...
    description: "Create tiered subscription system",
    category: "domain",
    tags: ["saas", "subscriptions", "pricing"],
    priority: 4,
  },
  {
    id: "usage-tracking",
    ...
    category: "domain",
    tags: ["saas", "usage", "analytics"],
    priority: 4,
  },
  {
    id: "team-management",
    name: "Team Management",
    description: "Build team invite and roles",
    category: "domain",
    tags: ["saas", "teams", "collaboration"],
    priority: 4,
  },
  {
    id: "audit-logging",
  ...
  },
  {
    ...
    description: "Create onboarding wizard",
    category: "domain",
    tags: ["saas", "onboarding", "ux"],
    priority: 4,
  },
  {
    id: "feature-flags",
  ...
  },
  {
    ...
    category: "domain",
    tags: ["saas", "notifications", "alerts"],
    priority: 4,
  },
  {
    id: "settings-page",
    name: "Settings Page",
    description: "Create comprehensive settings",
    category: "domain",
  ...
  },
  {
    ...
    description: "Build analytics views",
    category: "domain",
  ...
  },
  {
    id: "video-player",
    name: "Video Player",
    description: "Create custom video player",
    category: "domain",
  ...
  },
  {
    ...
    description: "Implement WYSIWYG editor",
    category: "domain",
  ...
  },
  {
    ...
    description: "Create markdown editor",
    category: "domain",
  ...
  },
  {
    id: "blog-system",
    name: "Blog System",
    description: "Build blog with posts/comments",
    category: "domain",
  ...
  },
  {
    id: "comment-system",
    name: "Comment System",
    description: "Implement commenting",
    category: "domain",
  ...
  },
  {
    ...
    category: "domain",
    tags: ["search", "elasticsearch", "algolia"],
    priority: 4,
  },
  {
    ...
    category: "domain",
    tags: ["versioning", "history", "content"],
    priority: 3,
  },
  {
    id: "media-gallery",
    name: "Media Gallery",
    description: "Create image/video gallery",
    category: "domain",
    tags: ["gallery", "media", "lightbox"],
    priority: 3,
  },
  ...
  // ============================================================================
  {
    ...
    description: "Integrate OpenAI API",
    category: "ai",
    tags: ["openai", "gpt", "llm"],
    priority: 5,
  },
  ...
  },
  {
    ...
    description: "Configure LangChain pipelines",
    category: "ai",
  ...
  },
  {
    ...
    description: "Build retrieval-augmented generation",
    category: "ai",
  ...
  },
  {
    ...
    description: "Create and use embeddings",
    category: "ai",
  ...
  },
  {
    ...
    description: "Configure vector stores",
    category: "ai",
    tags: ["vectors", "pinecone", "database"],
    priority: 4,
  },
  {
    id: "chatbot-creation",
    ...
    category: "ai",
    tags: ["chatbot", "conversation", "llm"],
    priority: 5,
  },
  {
    id: "ai-streaming",
    name: "AI Streaming Response",
    description: "Implement streaming LLM output",
    category: "ai",
  ...
  },
  {
    ...
    description: "Implement tool/function calling",
    category: "ai",
    tags: ["functions", "tools", "agents"],
    priority: 5,
  },
  {
    id: "ai-agent",
    ...
    category: "ai",
    tags: ["agents", "autonomous", "llm"],
    priority: 4,
  },
  {
    id: "text-classification",
    name: "Text Classification",
    description: "Classify text with ML",
    category: "ai",
  ...
  },
  {
    ...
    category: "ai",
    tags: ["summarization", "llm", "content"],
    priority: 4,
  },
  {
    id: "semantic-search",
  ...
  // ============================================================================
  {
    id: "lazy-loading",
    name: "Lazy Loading",
    description: "Implement lazy loading patterns",
  ...
  },
  {
    id: "code-splitting",
    name: "Code Splitting",
    description: "Split bundles for faster loads",
    category: "performance",
    tags: ["splitting", "bundles", "webpack"],
    priority: 5,
  },
  {
    id: "image-lazy-load",
  ...
  },
  {
    ...
    category: "performance",
    tags: ["memo", "cache", "optimization"],
    priority: 4,
  },
  {
    id: "debounce-throttle",
    name: "Debounce/Throttle",
    description: "Implement rate limiting patterns",
    category: "performance",
  ...
  },
  {
    ...
    category: "performance",
    tags: ["workers", "threads", "background"],
    priority: 3,
  },
  {
    id: "service-workers",
    name: "Service Workers",
    description: "Implement offline-first PWA",
    category: "performance",
  ...
  },
  {
    ...
    category: "performance",
    tags: ["css", "critical", "rendering"],
    priority: 3,
  },
  {
    id: "tree-shaking",
    name: "Tree Shaking",
    description: "Optimize bundle tree shaking",
    category: "performance",
    tags: ["tree-shaking", "bundle", "dead-code"],
    priority: 4,
  },
  {
    id: "compression",
    name: "Asset Compression",
    description: "Configure gzip/brotli compression",
    category: "performance",
  ...
  },
  {
    id: "n+1-query-fix",
    name: "N+1 Query Fix",
    description: "Identify and fix N+1 queries",
    category: "performance",
    tags: ["database", "n+1", "optimization"],
    priority: 4,
  },
  ...
  // ============================================================================
  {
    ...
    description: "Create accessible form controls",
  ...
  },
  {
    ...
    description: "Build keyboard-accessible nav",
    category: "accessibility",
  ...
  },
  {
    ...
    description: "Create accessible dialogs",
    category: "accessibility",
    tags: ["a11y", "modal", "focus-trap"],
    priority: 4,
  },
  {
    id: "a11y-images",
    name: "Accessible Images",
    description: "Add proper alt text and ARIA",
    category: "accessibility",
    tags: ["a11y", "images", "alt-text"],
    priority: 4,
  },
  {
    id: "a11y-color-contrast",
    name: "Color Contrast",
    description: "Ensure WCAG color contrast",
    category: "accessibility",
  ...
  },
  {
    ...
    category: "accessibility",
    tags: ["a11y", "screen-reader", "aria"],
    priority: 4,
  },
  {
    id: "a11y-focus-management",
    name: "Focus Management",
    description: "Manage focus properly",
    category: "accessibility",
  ...
  },
  {
    ...
    category: "accessibility",
    tags: ["a11y", "skip-links", "navigation"],
    priority: 3,
  },
  {
    id: "a11y-tables",
  ...
  },
  {
    ...
    description: "Implement branching model",
    category: "git",
  ...
  },
  {
    id: "git-rebase",
    name: "Git Rebase",
    description: "Clean history with rebase",
    category: "git",
  ...
  },
  {
    ...
    category: "git",
    tags: ["git", "hooks", "husky"],
    priority: 4,
  },
  {
    id: "git-bisect",
    name: "Git Bisect",
    description: "Find bugs with bisect",
    category: "git",
  ...
  },
  {
    ...
    category: "git",
    tags: ["git", "submodules", "monorepo"],
    priority: 3,
  },
  {
    id: "git-release",
    name: "Git Release Process",
    description: "Create release workflow",
    category: "git",
    tags: ["git", "releases", "tags"],
    priority: 4,
  },
  ...
  // ============================================================================
  {
    ...
    description: "Set up ESLint rules",
    category: "quality",
  ...
  },
  {
    ...
    description: "Configure Prettier formatting",
    category: "quality",
  ...
  },
  {
    ...
    category: "quality",
    tags: ["lint-staged", "commits", "automation"],
    priority: 4,
  },
  {
    id: "commitlint",
    name: "Commitlint Setup",
    description: "Enforce commit conventions",
    category: "quality",
    tags: ["commitlint", "commits", "conventional"],
    priority: 3,
  },
  {
    id: "editorconfig",
    name: "EditorConfig Setup",
    description: "Configure EditorConfig",
    category: "quality",
  ...
  },
  {
    ...
    description: "Configure CSS linting",
    category: "quality",
    tags: ["stylelint", "css", "linting"],
    priority: 3,
  },
  {
    id: "sonarqube",
    name: "SonarQube Integration",
    description: "Add code quality analysis",
    category: "quality",
    tags: ["sonarqube", "analysis", "quality"],
    priority: 3,
  },
  {
    id: "biome-setup",
    name: "Biome Setup",
    description: "Configure Biome linter",
    category: "quality",
  ...
  // ============================================================================
  {
    id: "debug-react",
    name: "Debug React",
    description: "Debug React applications",
    category: "debugging",
  ...
  },
  {
    ...
    category: "debugging",
    tags: ["nodejs", "debugging", "inspector"],
    priority: 4,
  },
  {
    id: "debug-network",
    name: "Debug Network Issues",
    description: "Troubleshoot API/network",
    category: "debugging",
    tags: ["network", "api", "debugging"],
    priority: 4,
  },
  {
  ...
  },
  {
    ...
    category: "debugging",
    tags: ["typescript", "errors", "types"],
    priority: 5,
  },
  {
    id: "debug-css",
    name: "Debug CSS Issues",
    description: "Fix CSS/layout problems",
    category: "debugging",
  ...
  },
  {
    ...
    description: "Debug promises/async",
    category: "debugging",
  ...
  {
    id: "debug-ssr",
    name: "Debug SSR Issues",
    description: "Fix server rendering problems",
    category: "debugging",
  ...
  },
  {
    ...
    description: "Fix build/bundle errors",
    category: "debugging",
    tags: ["build", "webpack", "debugging"],
    priority: 4,
  },
  ...
  // ============================================================================
  {
    ...
    description: "Format dates properly",
    category: "utilities",
    tags: ["dates", "formatting", "i18n"],
    priority: 4,
  },
  {
    id: "number-formatting",
    name: "Number Formatting",
    description: "Format numbers/currency",
    category: "utilities",
    tags: ["numbers", "currency", "formatting"],
    priority: 4,
  },
  {
  ...
  },
  {
    ...
    category: "utilities",
    tags: ["arrays", "utilities", "helpers"],
    priority: 4,
  },
  {
    id: "object-utils",
    name: "Object Utilities",
    description: "Object manipulation helpers",
    category: "utilities",
    tags: ["objects", "utilities", "helpers"],
    priority: 4,
  },
  {
    id: "url-parsing",
    ...
    category: "utilities",
    tags: ["url", "parsing", "query-strings"],
    priority: 4,
  },
  {
    id: "json-utils",
  ...
  },
  {
    id: "deep-clone",
    name: "Deep Clone",
    description: "Deep clone objects/arrays",
    category: "utilities",
    tags: ["clone", "deep", "objects"],
    priority: 3,
  },
  {
  ...
  },
  {
    id: "event-emitter",
    name: "Event Emitter",
    description: "Create event emitter pattern",
    category: "utilities",
    tags: ["events", "emitter", "pubsub"],
    priority: 3,
  },
  {
    id: "retry-logic",
