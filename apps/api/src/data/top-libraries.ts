...
export const TOP_LIBRARIES: LibraryEntry[] = [
  ...
  {
    name: "react",
    searchQuery: "React JavaScript UI library",
    categories: ["frontend"],
    priority: 5,
  },
  {
    name: "vue",
    searchQuery: "Vue.js progressive framework",
    categories: ["frontend"],
    priority: 5,
  },
  {
    name: "angular",
    searchQuery: "Angular TypeScript framework",
    categories: ["frontend"],
    priority: 5,
  },
  {
    name: "svelte",
    searchQuery: "Svelte compiler framework",
    categories: ["frontend"],
    priority: 5,
  },
  {
    name: "solid",
    searchQuery: "SolidJS reactive framework",
    categories: ["frontend"],
    priority: 4,
  },
  {
    name: "preact",
    searchQuery: "Preact lightweight React alternative",
    categories: ["frontend"],
    priority: 4,
  },
  ...
  {
    name: "alpine",
    searchQuery: "Alpine.js lightweight framework",
    categories: ["frontend"],
    priority: 4,
  },
  ...
  {
    name: "stimulus",
    searchQuery: "Stimulus JavaScript framework",
    categories: ["frontend"],
    priority: 3,
  },
  {
    name: "mithril",
    searchQuery: "Mithril JavaScript framework",
    categories: ["frontend"],
    priority: 3,
  },
  {
    name: "inferno",
    searchQuery: "Inferno fast React-like library",
    categories: ["frontend"],
    priority: 2,
  },
  ...
  {
    name: "nextjs",
    searchQuery: "Next.js React framework",
    categories: ["frontend", "fullstack"],
    priority: 5,
  },
  {
    name: "nuxt",
    searchQuery: "Nuxt Vue framework",
    categories: ["frontend", "fullstack"],
    priority: 5,
  },
  {
    name: "remix",
    searchQuery: "Remix React framework",
    categories: ["frontend", "fullstack"],
    priority: 5,
  },
  ...
  {
    name: "sveltekit",
    searchQuery: "SvelteKit framework",
    categories: ["frontend", "fullstack"],
    priority: 5,
  },
  ...
  {
    name: "solidstart",
    searchQuery: "SolidStart meta framework",
    categories: ["frontend", "fullstack"],
    priority: 3,
  },
  {
    name: "analog",
    searchQuery: "Analog Angular meta framework",
    categories: ["frontend", "fullstack"],
    priority: 3,
  },
  {
    name: "fresh",
    searchQuery: "Fresh Deno framework",
    categories: ["frontend", "fullstack"],
    priority: 3,
  },
  {
    name: "eleventy",
    searchQuery: "Eleventy static site generator",
    categories: ["frontend"],
    priority: 3,
  },
  {
    name: "hugo",
    searchQuery: "Hugo static site generator",
    categories: ["frontend"],
    priority: 3,
  },
  {
    name: "jekyll",
    searchQuery: "Jekyll static site generator",
    categories: ["frontend"],
    priority: 3,
  },
  ...
  {
    name: "express",
    searchQuery: "Express Node.js framework",
    categories: ["backend"],
    priority: 5,
  },
  {
    name: "fastify",
    searchQuery: "Fastify Node.js framework",
    categories: ["backend"],
    priority: 5,
  },
  {
    name: "hono",
    searchQuery: "Hono edge framework",
  ...
  {
    name: "adonis",
    searchQuery: "AdonisJS framework",
  ...
  {
    name: "django",
    searchQuery: "Django Python framework",
    categories: ["backend", "fullstack"],
    priority: 5,
  },
  {
    name: "flask",
    searchQuery: "Flask Python microframework",
    categories: ["backend"],
    priority: 5,
  },
  {
    name: "fastapi",
    searchQuery: "FastAPI Python framework",
    categories: ["backend"],
    priority: 5,
  },
  {
    name: "starlette",
    searchQuery: "Starlette ASGI framework",
    categories: ["backend"],
    priority: 4,
  },
  {
    name: "tornado",
    searchQuery: "Tornado Python web framework",
    categories: ["backend"],
    priority: 3,
  },
  {
    name: "pyramid",
    searchQuery: "Pyramid Python framework",
    categories: ["backend"],
    priority: 3,
  },
  {
    name: "bottle",
    searchQuery: "Bottle Python microframework",
    categories: ["backend"],
    priority: 3,
  },
  {
    name: "falcon",
    searchQuery: "Falcon Python REST framework",
    categories: ["backend"],
    priority: 3,
  },
  {
    name: "sanic",
    searchQuery: "Sanic async Python framework",
    categories: ["backend"],
    priority: 3,
  },
  {
    name: "litestar",
    searchQuery: "Litestar Python framework",
    categories: ["backend"],
    priority: 3,
  },
  ...
  {
    name: "buffalo",
    searchQuery: "Buffalo Go web framework",
    categories: ["backend"],
    priority: 3,
  },
  ...
  {
    name: "rocket",
    searchQuery: "Rocket Rust web framework",
    categories: ["backend"],
    priority: 4,
  },
  ...
  {
    name: "rails",
    searchQuery: "Ruby on Rails framework",
    categories: ["backend", "fullstack"],
    priority: 5,
  },
  ...
  {
    name: "laravel",
    searchQuery: "Laravel PHP framework",
    categories: ["backend", "fullstack"],
    priority: 5,
  },
  ...
  {
    name: "codeigniter",
    searchQuery: "CodeIgniter PHP framework",
    categories: ["backend"],
    priority: 3,
  },
  ...
  {
    name: "spring",
    searchQuery: "Spring Boot Java framework",
    categories: ["backend"],
    priority: 5,
  },
  ...
  {
    name: "micronaut",
    searchQuery: "Micronaut Java framework",
    categories: ["backend"],
    priority: 4,
  },
  ...
  {
    name: "blazor",
    searchQuery: "Blazor web framework",
    categories: ["frontend", "fullstack"],
    priority: 4,
  },
  ...
  {
    name: "prisma",
    searchQuery: "Prisma ORM TypeScript",
    categories: ["database", "backend"],
    priority: 5,
  },
  {
    name: "drizzle",
    searchQuery: "Drizzle ORM SQL",
    categories: ["database", "backend"],
    priority: 5,
  },
  ...
  {
    name: "sequelize",
    searchQuery: "Sequelize ORM Node.js",
    categories: ["database"],
    priority: 4,
  },
  ...
  {
    name: "sqlalchemy",
    searchQuery: "SQLAlchemy Python ORM",
    categories: ["database"],
    priority: 5,
  },
  ...
  {
    name: "tortoise-orm",
    searchQuery: "Tortoise ORM async Python",
    categories: ["database"],
    priority: 3,
  },
  ...
  {
    name: "mongodb",
    searchQuery: "MongoDB database driver",
    categories: ["database"],
    priority: 5,
  },
  ...
  {
    name: "cassandra",
    searchQuery: "Cassandra database driver",
    categories: ["database"],
    priority: 3,
  },
  {
    name: "elasticsearch",
    searchQuery: "Elasticsearch client",
    categories: ["database"],
    priority: 4,
  },
  ...
  {
    name: "dynamodb",
    searchQuery: "DynamoDB AWS database",
    categories: ["database", "cloud"],
    priority: 4,
  },
  {
    name: "planetscale",
    searchQuery: "PlanetScale database",
    categories: ["database", "cloud"],
    priority: 3,
  },
  {
    name: "turso",
    searchQuery: "Turso SQLite edge database",
    categories: ["database", "cloud"],
    priority: 3,
  },
  {
    name: "neon",
    searchQuery: "Neon serverless Postgres",
    categories: ["database", "cloud"],
    priority: 3,
  },
  ...
  {
    name: "redux",
    searchQuery: "Redux state management",
    categories: ["frontend", "utilities"],
    priority: 5,
  },
  {
    name: "zustand",
    searchQuery: "Zustand React state",
    categories: ["frontend", "utilities"],
    priority: 5,
  },
  ...
  {
    name: "effector",
    searchQuery: "Effector state manager",
    categories: ["frontend"],
    priority: 3,
  },
  {
    name: "legend-state",
    searchQuery: "Legend State React",
    categories: ["frontend"],
    priority: 2,
  },
  ...
  {
    name: "tanstack-query",
    searchQuery: "TanStack Query React",
    categories: ["frontend", "utilities"],
    priority: 5,
  },
  ...
  {
    name: "apollo-client",
    searchQuery: "Apollo GraphQL client",
    categories: ["frontend"],
    priority: 5,
  },
  ...
  { name: "ofetch", searchQuery: "ofetch universal fetch", categories: ["utilities"], priority: 3 },
  {
    ...
    searchQuery: "graphql-request client",
  ...
  {
    name: "react-router",
    searchQuery: "React Router navigation",
    categories: ["frontend"],
    priority: 5,
  },
  {
    name: "tanstack-router",
    searchQuery: "TanStack Router typesafe",
    categories: ["frontend"],
    priority: 4,
  },
  ...
  {
    name: "vue-router",
    searchQuery: "Vue Router navigation",
    categories: ["frontend"],
    priority: 5,
  },
  {
    name: "reach-router",
    searchQuery: "Reach Router accessible",
    categories: ["frontend"],
    priority: 2,
  },
  ...
  {
    name: "tailwindcss",
    searchQuery: "Tailwind CSS utility",
  ...
  {
    name: "material-ui",
    searchQuery: "Material UI React MUI",
    categories: ["frontend"],
    priority: 5,
  },
  {
    name: "ant-design",
    searchQuery: "Ant Design components",
    categories: ["frontend"],
    priority: 4,
  },
  {
    name: "mantine",
    searchQuery: "Mantine React components",
    categories: ["frontend"],
    priority: 4,
  },
  {
    name: "headless-ui",
    searchQuery: "Headless UI components",
    categories: ["frontend"],
    priority: 4,
  },
  {
    name: "daisyui",
    searchQuery: "DaisyUI Tailwind components",
    categories: ["frontend"],
    priority: 4,
  },
  {
    name: "flowbite",
    searchQuery: "Flowbite Tailwind components",
    categories: ["frontend"],
    priority: 3,
  },
  {
    name: "primereact",
    searchQuery: "PrimeReact components",
    categories: ["frontend"],
    priority: 3,
  },
  ...
  {
    name: "bootstrap",
    searchQuery: "Bootstrap CSS framework",
    categories: ["frontend", "styling"],
    priority: 4,
  },
  {
    name: "bulma",
    searchQuery: "Bulma CSS framework",
    categories: ["frontend", "styling"],
    priority: 3,
  },
  {
    name: "unocss",
    searchQuery: "UnoCSS atomic CSS",
    categories: ["frontend", "styling"],
    priority: 3,
  },
  {
    name: "panda-css",
    searchQuery: "Panda CSS styling",
    categories: ["frontend", "styling"],
    priority: 3,
  },
  {
    name: "vanilla-extract",
    searchQuery: "Vanilla Extract CSS",
    categories: ["frontend", "styling"],
    priority: 3,
  },
  {
    name: "stitches",
    searchQuery: "Stitches CSS-in-JS",
    categories: ["frontend", "styling"],
    priority: 2,
  },
  {
    name: "styled-components",
    searchQuery: "styled-components CSS-in-JS",
    categories: ["frontend", "styling"],
    priority: 4,
  },
  {
    name: "emotion",
    searchQuery: "Emotion CSS-in-JS",
    categories: ["frontend", "styling"],
    priority: 4,
  },
  ...
  {
    name: "playwright",
    searchQuery: "Playwright e2e testing",
    categories: ["testing"],
    priority: 5,
  },
  { name: "cypress", searchQuery: "Cypress e2e testing", categories: ["testing"], priority: 5 },
  {
    ...
    searchQuery: "Testing Library DOM",
    categories: ["testing"],
    priority: 5,
  },
  ...
  {
    name: "storybook",
    searchQuery: "Storybook UI testing",
  ...
  {
    name: "supertest",
    searchQuery: "SuperTest HTTP testing",
    categories: ["testing"],
    priority: 3,
  },
  ...
  {
    name: "unittest",
    searchQuery: "Python unittest testing",
    categories: ["testing"],
    priority: 3,
  },
  ...
  {
    name: "turbopack",
    searchQuery: "Turbopack Vercel bundler",
    categories: ["devops"],
    priority: 4,
  },
  ...
  {
    name: "turborepo",
    searchQuery: "Turborepo monorepo build",
    categories: ["devops"],
    priority: 5,
  },
  ...
  {
    name: "typescript",
    searchQuery: "TypeScript language",
    categories: ["utilities"],
    priority: 5,
  },
  ...
  {
    name: "arktype",
    searchQuery: "ArkType TypeScript validation",
    categories: ["utilities"],
    priority: 3,
  },
  {
    name: "superstruct",
    searchQuery: "Superstruct validation",
    categories: ["utilities"],
    priority: 2,
  },
  {
    name: "io-ts",
    searchQuery: "io-ts TypeScript runtime",
    categories: ["utilities"],
    priority: 2,
  },
  {
    name: "class-validator",
    searchQuery: "class-validator decorators",
    categories: ["utilities"],
    priority: 3,
  },
  ...
  {
    name: "nextauth",
    searchQuery: "NextAuth.js authentication",
    categories: ["auth"],
    priority: 5,
  },
  ...
  {
    name: "better-auth",
    searchQuery: "Better Auth authentication",
    categories: ["auth"],
    priority: 3,
  },
  {
    name: "supertokens",
    searchQuery: "SuperTokens authentication",
    categories: ["auth"],
    priority: 3,
  },
  {
    name: "keycloak",
    searchQuery: "Keycloak identity management",
    categories: ["auth"],
    priority: 3,
  },
  ...
  {
    name: "firebase-auth",
    searchQuery: "Firebase Authentication",
    categories: ["auth", "cloud"],
    priority: 4,
  },
  {
    name: "cognito",
    searchQuery: "AWS Cognito authentication",
    categories: ["auth", "cloud"],
    priority: 3,
  },
  {
    name: "oauth",
    searchQuery: "OAuth authentication protocol",
    categories: ["auth"],
    priority: 4,
  },
  ...
  // ============================================================================
  {
    ...
    searchQuery: "Cloudflare Workers edge",
    categories: ["cloud", "backend"],
    priority: 5,
  },
  {
    name: "cloudflare-pages",
    searchQuery: "Cloudflare Pages deployment",
    categories: ["cloud"],
    priority: 4,
  },
  {
    name: "cloudflare-d1",
    searchQuery: "Cloudflare D1 database",
    categories: ["cloud", "database"],
    priority: 4,
  },
  {
    name: "cloudflare-r2",
    searchQuery: "Cloudflare R2 storage",
    categories: ["cloud"],
    priority: 4,
  },
  {
    name: "cloudflare-kv",
    searchQuery: "Cloudflare KV storage",
    categories: ["cloud"],
    priority: 4,
  },
  {
    name: "cloudflare-durable-objects",
    searchQuery: "Cloudflare Durable Objects",
    categories: ["cloud"],
    priority: 4,
  },
  ...
  {
    name: "netlify",
    searchQuery: "Netlify deployment platform",
    categories: ["cloud"],
    priority: 4,
  },
  {
    name: "railway",
    searchQuery: "Railway deployment platform",
    categories: ["cloud"],
    priority: 3,
  },
  ...
  {
    name: "aws-cdk",
    searchQuery: "AWS CDK infrastructure",
  ...
  {
    name: "aws-amplify",
    searchQuery: "AWS Amplify fullstack",
  ...
  {
    name: "firebase",
    searchQuery: "Firebase Google platform",
    categories: ["cloud", "backend"],
    priority: 5,
  },
  {
    name: "firestore",
    searchQuery: "Firebase Firestore database",
    categories: ["cloud", "database"],
    priority: 4,
  },
  ...
  { name: "azure", searchQuery: "Azure SDK JavaScript", categories: ["cloud"], priority: 4 },
  {
    ...
    searchQuery: "Azure Functions serverless",
    categories: ["cloud"],
    priority: 3,
  },
  ...
  {
    name: "supabase",
    searchQuery: "Supabase open source Firebase",
    categories: ["database", "backend", "cloud"],
    priority: 5,
  },
  {
    name: "appwrite",
    searchQuery: "Appwrite backend platform",
    categories: ["backend", "cloud"],
    priority: 4,
  },
  {
    name: "pocketbase",
    searchQuery: "PocketBase backend",
    categories: ["backend", "cloud"],
    priority: 3,
  },
  {
    name: "convex",
    searchQuery: "Convex reactive backend",
    categories: ["backend", "cloud"],
    priority: 4,
  },
  ...
  {
    name: "huggingface",
    searchQuery: "Hugging Face transformers",
    categories: ["ai"],
    priority: 4,
  },
  ...
  {
    name: "tensorflow",
    searchQuery: "TensorFlow machine learning",
    categories: ["ai"],
    priority: 5,
  },
  ...
  {
    name: "numpy",
    searchQuery: "NumPy numerical Python",
    categories: ["ai", "utilities"],
    priority: 5,
  },
  {
    name: "pandas",
    searchQuery: "Pandas data analysis",
    categories: ["ai", "utilities"],
    priority: 5,
  },
  {
    name: "pinecone",
    searchQuery: "Pinecone vector database",
    categories: ["ai", "database"],
    priority: 4,
  },
  {
    name: "weaviate",
    searchQuery: "Weaviate vector database",
    categories: ["ai", "database"],
    priority: 3,
  },
  {
    name: "qdrant",
    searchQuery: "Qdrant vector database",
    categories: ["ai", "database"],
    priority: 3,
  },
  {
    name: "chromadb",
    searchQuery: "ChromaDB vector database",
    categories: ["ai", "database"],
    priority: 3,
  },
  {
    name: "milvus",
    searchQuery: "Milvus vector database",
    categories: ["ai", "database"],
    priority: 3,
  },
  ...
  {
    name: "ramda",
    searchQuery: "Ramda functional library",
    categories: ["utilities"],
    priority: 3,
  },
  {
    name: "date-fns",
    searchQuery: "date-fns date utility",
    categories: ["utilities"],
    priority: 5,
  },
  ...
  {
    name: "fp-ts",
    searchQuery: "fp-ts functional TypeScript",
    categories: ["utilities"],
    priority: 3,
  },
  ...
  {
    name: "neverthrow",
    searchQuery: "neverthrow Result type",
    categories: ["utilities"],
    priority: 2,
  },
  {
    name: "ts-pattern",
    searchQuery: "ts-pattern matching",
    categories: ["utilities"],
    priority: 3,
  },
  ...
  {
    name: "docusaurus",
    searchQuery: "Docusaurus documentation",
    categories: ["frontend"],
    priority: 4,
  },
  {
    name: "vitepress",
    searchQuery: "VitePress Vue documentation",
    categories: ["frontend"],
    priority: 4,
  },
  ...
  {
    name: "mintlify",
    searchQuery: "Mintlify documentation",
    categories: ["frontend"],
    priority: 3,
  },
  ...
  {
    name: "contentlayer",
    searchQuery: "Contentlayer content",
    categories: ["frontend"],
    priority: 3,
  },
  ...
  {
    name: "framer-motion",
    searchQuery: "Framer Motion animation",
    categories: ["frontend"],
    priority: 5,
  },
  ...
  {
    name: "react-spring",
    searchQuery: "react-spring animation",
    categories: ["frontend"],
    priority: 4,
  },
  ...
  {
    name: "lottie",
    searchQuery: "Lottie animation library",
    categories: ["frontend"],
    priority: 4,
  },
  {
    name: "rive",
    searchQuery: "Rive interactive animation",
    categories: ["frontend"],
    priority: 3,
  },
  { name: "three", searchQuery: "Three.js 3D JavaScript", categories: ["frontend"], priority: 5 },
  {
    ...
    searchQuery: "React Three Fiber 3D",
    categories: ["frontend"],
    priority: 4,
  },
  ...
  {
    name: "visx",
    searchQuery: "visx visualization primitives",
    categories: ["frontend"],
    priority: 3,
  },
  ...
  {
    name: "vee-validate",
    searchQuery: "VeeValidate Vue forms",
    categories: ["frontend"],
    priority: 4,
  },
  {
    name: "react-final-form",
    searchQuery: "React Final Form",
    categories: ["frontend"],
    priority: 3,
  },
  {
    name: "conform",
    searchQuery: "Conform form validation",
    categories: ["frontend"],
    priority: 3,
  },
  ...
  {
    name: "tanstack-table",
    searchQuery: "TanStack Table headless",
    categories: ["frontend"],
    priority: 5,
  },
  ...
  {
    name: "handsontable",
    searchQuery: "Handsontable spreadsheet",
    categories: ["frontend"],
    priority: 3,
  },
  {
    name: "react-data-grid",
    searchQuery: "React Data Grid",
    categories: ["frontend"],
    priority: 3,
  },
  {
    name: "tanstack-virtual",
    searchQuery: "TanStack Virtual scrolling",
    categories: ["frontend"],
    priority: 4,
  },
  {
    name: "react-window",
    searchQuery: "react-window virtual list",
    categories: ["frontend"],
    priority: 3,
  },
  {
    name: "react-virtualized",
    searchQuery: "react-virtualized efficient",
    categories: ["frontend"],
    priority: 3,
  },
  ...
  {
    name: "socket.io",
    searchQuery: "Socket.IO real-time",
    categories: ["backend", "utilities"],
    priority: 5,
  },
  {
    name: "pusher",
    searchQuery: "Pusher real-time",
    categories: ["backend", "cloud"],
    priority: 4,
  },
  {
    name: "ably",
    searchQuery: "Ably real-time messaging",
    categories: ["backend", "cloud"],
    priority: 3,
  },
  {
    name: "partykit",
    searchQuery: "PartyKit real-time",
    categories: ["backend", "cloud"],
    priority: 3,
  },
  {
    name: "liveblocks",
    searchQuery: "Liveblocks collaboration",
    categories: ["backend", "cloud"],
    priority: 4,
  },
  ...
  {
    name: "websocket",
    searchQuery: "WebSocket API protocol",
    categories: ["utilities"],
    priority: 4,
  },
  ...
  {
    name: "graphql-ws",
    searchQuery: "graphql-ws subscriptions",
    categories: ["utilities"],
    priority: 3,
  },
  ...
  { name: "shopify", searchQuery: "Shopify e-commerce API", categories: ["backend"], priority: 5 },
  {
    ...
    searchQuery: "Shopify Hydrogen React",
    categories: ["frontend", "fullstack"],
    priority: 4,
  },
  ...
  {
    name: "medusa",
    searchQuery: "Medusa open source commerce",
    categories: ["backend", "fullstack"],
    priority: 4,
  },
  ...
  {
    name: "vendure",
    searchQuery: "Vendure TypeScript commerce",
    categories: ["backend"],
    priority: 3,
  },
  ...
  {
    name: "snipcart",
    searchQuery: "Snipcart shopping cart",
    categories: ["frontend"],
    priority: 3,
  },
  {
    name: "lemonsqueezy",
    searchQuery: "Lemon Squeezy payments",
    categories: ["backend"],
    priority: 3,
  },
  ...
  {
    name: "kotlin",
    searchQuery: "Kotlin Android development",
    categories: ["mobile"],
    priority: 4,
  },
  {
    name: "jetpack-compose",
    searchQuery: "Jetpack Compose Android",
    categories: ["mobile"],
    priority: 4,
  },
  ...
  {
    name: "neutralino",
    searchQuery: "Neutralino lightweight desktop",
    categories: ["mobile"],
    priority: 2,
  },
  ...
  {
    name: "nodemailer",
    searchQuery: "Nodemailer email Node.js",
    categories: ["backend"],
    priority: 4,
  },
  {
    name: "resend",
    searchQuery: "Resend email API",
    categories: ["backend", "cloud"],
    priority: 4,
  },
  {
    name: "sendgrid",
    searchQuery: "SendGrid email API",
    categories: ["backend", "cloud"],
    priority: 4,
  },
  {
    name: "mailgun",
    searchQuery: "Mailgun email API",
    categories: ["backend", "cloud"],
    priority: 3,
  },
  {
    name: "postmark",
    searchQuery: "Postmark email API",
    categories: ["backend", "cloud"],
    priority: 3,
  },
  {
    name: "react-email",
    searchQuery: "React Email components",
    categories: ["frontend"],
    priority: 4,
  },
  ...
  {
    name: "uploadthing",
    searchQuery: "UploadThing file uploads",
    categories: ["backend", "cloud"],
    priority: 4,
  },
  {
    name: "multer",
    searchQuery: "Multer file upload middleware",
    categories: ["backend"],
    priority: 4,
  },
  {
    name: "formidable",
    searchQuery: "Formidable file parsing",
    categories: ["backend"],
    priority: 3,
  },
  ...
  {
    name: "pdf-lib",
    searchQuery: "pdf-lib PDF generation",
    categories: ["utilities"],
    priority: 3,
  },
  {
    name: "pdfkit",
    searchQuery: "PDFKit document generation",
    categories: ["utilities"],
    priority: 3,
  },
  {
    name: "docx",
    searchQuery: "docx Word document generation",
    categories: ["utilities"],
    priority: 2,
  },
  ...
  {
    name: "papaparse",
    searchQuery: "PapaParse CSV parsing",
    categories: ["utilities"],
    priority: 3,
  },
  ...
  {
    name: "logrocket",
    searchQuery: "LogRocket session replay",
    categories: ["devops"],
    priority: 3,
  },
  ...
  {
    name: "highlight",
    searchQuery: "Highlight.io monitoring",
    categories: ["devops"],
    priority: 3,
  },
  ...
  {
    name: "picocolors",
    searchQuery: "picocolors terminal",
    categories: ["utilities"],
    priority: 3,
  },
  ...
  {
    name: "fast-glob",
    searchQuery: "fast-glob file matching",
    categories: ["utilities"],
    priority: 3,
  },
  {
    name: "chokidar",
    searchQuery: "Chokidar file watching",
    categories: ["utilities"],
    priority: 4,
  },
  ...
  {
    name: "lint-staged",
    searchQuery: "lint-staged staged files",
    categories: ["devops"],
    priority: 4,
  },
  {
    name: "commitlint",
    searchQuery: "commitlint commit messages",
    categories: ["devops"],
    priority: 3,
  },
  {
    name: "semantic-release",
    searchQuery: "semantic-release versioning",
    categories: ["devops"],
    priority: 3,
  },
  ...
  {
    name: "apollo-server",
    searchQuery: "Apollo Server GraphQL",
    categories: ["backend"],
    priority: 5,
  },
  {
    name: "graphql-yoga",
    searchQuery: "GraphQL Yoga server",
    categories: ["backend"],
    priority: 4,
  },
  ...
  {
    name: "type-graphql",
    searchQuery: "TypeGraphQL decorators",
    categories: ["backend"],
    priority: 3,
  },
  {
    name: "mercurius",
    searchQuery: "Mercurius Fastify GraphQL",
    categories: ["backend"],
    priority: 3,
  },
  {
    name: "graphql-codegen",
    searchQuery: "GraphQL Code Generator",
    categories: ["devops"],
    priority: 4,
  },
  {
    name: "gql-tag",
    searchQuery: "graphql-tag template literals",
    categories: ["utilities"],
    priority: 3,
  },
  ...
  {
    name: "bee-queue",
    searchQuery: "Bee-Queue job processing",
    categories: ["backend"],
    priority: 2,
  },
  ...
  {
    name: "temporal",
    searchQuery: "Temporal workflow engine",
    categories: ["backend"],
    priority: 3,
  },
  {
    name: "inngest",
    searchQuery: "Inngest event-driven",
    categories: ["backend", "cloud"],
    priority: 3,
  },
  {
    name: "trigger-dev",
    searchQuery: "Trigger.dev background jobs",
    categories: ["backend", "cloud"],
    priority: 3,
  },
  ...
  {
    name: "rate-limiter",
    searchQuery: "rate-limiter Express",
    categories: ["backend"],
    priority: 3,
  },
  ...
  {
    name: "i18next",
    searchQuery: "i18next internationalization",
    categories: ["utilities"],
    priority: 4,
  },
  {
    name: "react-intl",
    searchQuery: "React Intl formatting",
    categories: ["frontend"],
    priority: 4,
  },
  {
    name: "formatjs",
    searchQuery: "FormatJS internationalization",
    categories: ["utilities"],
    priority: 3,
  },
  ...
  {
    name: "lingui",
    searchQuery: "Lingui internationalization",
    categories: ["utilities"],
    priority: 3,
  },
  {
    name: "next-intl",
    searchQuery: "next-intl Next.js i18n",
    categories: ["frontend"],
    priority: 3,
  },
  {
    name: "paraglide",
    searchQuery: "Paraglide i18n compiler",
    categories: ["utilities"],
    priority: 2,
  },
  ...
  {
    name: "remark",
    searchQuery: "remark Markdown processor",
    categories: ["utilities"],
    priority: 4,
  },
  ...
  {
    name: "markdown-it",
    searchQuery: "markdown-it parser",
    categories: ["utilities"],
    priority: 3,
  },
  ...
  {
    name: "prosemirror",
    searchQuery: "ProseMirror editor toolkit",
    categories: ["frontend"],
    priority: 4,
  },
  {
    name: "slate",
    searchQuery: "Slate rich text framework",
    categories: ["frontend"],
    priority: 4,
  },
  ...
  {
    name: "editorjs",
    searchQuery: "Editor.js block editor",
    categories: ["frontend"],
    priority: 3,
  },
  {
    name: "milkdown",
    searchQuery: "Milkdown Markdown editor",
    categories: ["frontend"],
    priority: 2,
  },
  ...
  {
    name: "dnd-kit",
    searchQuery: "dnd kit drag drop React",
    categories: ["frontend"],
    priority: 4,
  },
  {
    name: "react-beautiful-dnd",
    searchQuery: "react-beautiful-dnd",
    categories: ["frontend"],
    priority: 3,
  },
  ...
  {
    name: "sortablejs",
    searchQuery: "SortableJS drag sort",
    categories: ["frontend"],
    priority: 3,
  },
  { name: "dragula", searchQuery: "Dragula drag drop", categories: ["frontend"], priority: 2 },
  {
    ...
    searchQuery: "Pragmatic drag drop Atlassian",
    categories: ["frontend"],
    priority: 3,
  },
  ...
  {
    name: "floating-ui",
    searchQuery: "Floating UI positioning",
    categories: ["frontend"],
    priority: 4,
  },
  ...
  {
    name: "react-aria",
    searchQuery: "React Aria accessibility",
    categories: ["frontend"],
    priority: 4,
  },
  {
    name: "ariakit",
    searchQuery: "Ariakit accessible components",
    categories: ["frontend"],
    priority: 3,
  },
  ...
  // ============================================================================
  {
    ...
    searchQuery: "React Datepicker",
    categories: ["frontend"],
    priority: 3,
  },
  {
    name: "react-day-picker",
    searchQuery: "React Day Picker",
    categories: ["frontend"],
    priority: 3,
  },
  {
    name: "fullcalendar",
    searchQuery: "FullCalendar JavaScript",
    categories: ["frontend"],
    priority: 3,
  },
  {
    name: "react-big-calendar",
    searchQuery: "React Big Calendar",
    categories: ["frontend"],
    priority: 3,
  },
  ...
  {
    name: "react-map-gl",
    searchQuery: "react-map-gl Mapbox",
    categories: ["frontend"],
    priority: 3,
  },
  {
    name: "google-maps",
    searchQuery: "Google Maps JavaScript API",
    categories: ["frontend"],
    priority: 4,
  },
  ...
  {
    name: "wavesurfer",
    searchQuery: "wavesurfer.js audio waveform",
    categories: ["frontend"],
    priority: 2,
  },
  {
    name: "cloudinary",
    searchQuery: "Cloudinary media management",
    categories: ["cloud"],
    priority: 4,
  },
  ...
  {
    name: "terraform",
    searchQuery: "Terraform infrastructure",
    categories: ["devops"],
    priority: 5,
  },
  {
    name: "pulumi",
    searchQuery: "Pulumi infrastructure code",
    categories: ["devops"],
    priority: 4,
  },
  ...
  {
    name: "kubernetes",
    searchQuery: "Kubernetes container orchestration",
    categories: ["devops"],
    priority: 5,
  },
  ...
  {
    name: "github-actions",
    searchQuery: "GitHub Actions CI/CD",
    categories: ["devops"],
    priority: 5,
  },
  ...
  {
    name: "wasmer",
    searchQuery: "Wasmer WebAssembly runtime",
    categories: ["utilities"],
    priority: 2,
  },
  ...
  {
    name: "emscripten",
    searchQuery: "Emscripten WebAssembly compiler",
    categories: ["devops"],
    priority: 2,
  },
  ...
  {
    name: "service-worker",
    searchQuery: "Service Worker API",
    categories: ["frontend"],
    priority: 3,
  },
  {
    name: "workbox",
    searchQuery: "Workbox PWA service worker",
    categories: ["frontend"],
    priority: 4,
  },
  ...
  {
    name: "webrtc",
    searchQuery: "WebRTC real-time communication",
    categories: ["utilities"],
    priority: 3,
  },
  ...
  {
    name: "indexeddb",
    searchQuery: "IndexedDB browser storage",
    categories: ["frontend"],
    priority: 3,
  },
  {
    name: "dexie",
    searchQuery: "Dexie.js IndexedDB wrapper",
    categories: ["frontend"],
    priority: 3,
  },
  {
    name: "localforage",
    searchQuery: "localForage storage",
    categories: ["frontend"],
    priority: 3,
  },
  ...
  {
    name: "axe-core",
    searchQuery: "axe-core accessibility testing",
    categories: ["testing"],
    priority: 4,
  },
  {
    name: "pa11y",
    searchQuery: "Pa11y accessibility testing",
    categories: ["testing"],
    priority: 3,
  },
  {
    name: "lighthouse",
    searchQuery: "Lighthouse web auditing",
    categories: ["testing", "devops"],
    priority: 4,
  },
  {
    name: "focus-trap",
    searchQuery: "focus-trap accessibility",
    categories: ["frontend"],
    priority: 3,
  },
  ...
  {
    name: "react-helmet",
    searchQuery: "React Helmet head management",
    categories: ["frontend"],
    priority: 3,
  },
  {
    name: "schema-dts",
    searchQuery: "schema-dts structured data",
    categories: ["utilities"],
    priority: 2,
  },
  ...
  {
    name: "qrcode",
    searchQuery: "QRCode generation JavaScript",
    categories: ["utilities"],
    priority: 3,
  },
  {
    name: "barcode",
    searchQuery: "JsBarcode barcode generation",
    categories: ["utilities"],
    priority: 2,
  },
  {
    name: "json5",
    searchQuery: "JSON5 JavaScript object notation",
    categories: ["utilities"],
    priority: 2,
  },
  ...
  {
    name: "dotenv",
    searchQuery: "dotenv environment variables",
    categories: ["utilities"],
    priority: 4,
  },
  {
    name: "env-schema",
    searchQuery: "env-schema validation",
    categories: ["utilities"],
    priority: 2,
  },
  {
    name: "envalid",
    searchQuery: "envalid env validation",
    categories: ["utilities"],
    priority: 2,
  },
  ...
  {
    name: "bottleneck",
    searchQuery: "Bottleneck rate limiter",
    categories: ["utilities"],
    priority: 3,
  },
  ...
  {
    name: "eventemitter3",
    searchQuery: "EventEmitter3 events",
    categories: ["utilities"],
    priority: 3,
  },
