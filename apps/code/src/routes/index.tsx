...
import { Card, CardContent, CardDescription, CardHeader, CardTitle } from "@nexus/ui/components/card";
...
function ConnectionPage() {
  ...
  useEffect(() => {
    if (!isPending && !session?.user) {
      window.location.href = "https://nexus.yogan.dev/sign-in?redirect=https://code.nexus.yogan.dev";
    }
  }, [isPending, session]);
  ...
  return (
    <div className="flex-1 flex flex-col p-4 safe-area-left safe-area-right overflow-y-auto">
      {/* Header */}
