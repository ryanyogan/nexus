...
export default defineConfig({
  title: "Nexus",
  description:
    "The Documentation Oracle for AI - Persistent memory, documentation search, and MCP server discovery",
  ...
  head: [
    ...
    [
      "meta",
      {
        ...
        content:
          "Persistent memory, documentation search, and MCP server discovery for AI coding assistants",
      },
    ],
