...
import type { OpenCodeClient, Session, Message, FileNode, Todo } from "@/lib/code/opencode-types";
import { createOpenCodeClient } from "@/lib/code/opencode-client";
...
interface EditorState {
  ...
  // Recent connections (persisted locally)
  ...
  persist(
    (set, get) => ({
      ...
      loadRecentConnections: async () => {
        // Recent connections are persisted via zustand persist
      },
